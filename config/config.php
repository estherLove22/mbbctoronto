<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "MBBC Toronto", 
			"phone" =>  "647-220-5609", 		  //either no format or dashed format
			"email" => "info@mbbctoronto.ca",   //by default is used as recipient email  
			"address" => "Unit 201 - 1224 Lawrence Avenue West (Service Road),Toronto, ON M6A 1E3", 
			...
			"email_from_name" => "MBBC Toronto", //by default is the same as company name
